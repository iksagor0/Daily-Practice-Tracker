      ...
      <div className="bg-white rounded-4xl shadow-2xl w-full max-w-sm border border-white relative overflow-hidden animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="relative mb-3">
            ...
            />
            <div className="absolute inset-y-0 right-0 flex items-center pr-5 pointer-events-none text-slate-400 font-bold text-sm bg-linear-to-l from-slate-50 via-slate-50 rounded-r-2xl pl-2">
              min
            </div>
          </div>
