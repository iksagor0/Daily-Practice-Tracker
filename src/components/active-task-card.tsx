...
export const ActiveTaskCard: React.FC<ITaskCardProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-white border border-slate-200 transition-all duration-300 ease-in-out hover:border-brand-500/30 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center gap-4 group animate-slide-up fill-mode-forwards relative",
