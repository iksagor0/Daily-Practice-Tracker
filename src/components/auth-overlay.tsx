    ...
    <div className="fixed inset-0 bg-slate-50 z-[100] flex flex-col items-center justify-center transition-opacity duration-300 p-4">
      ...
      <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-white/50 w-full max-w-sm text-center transform transition-all animate-slide-up relative">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-brand-200 transition-all font-semibold py-3.5 px-6 rounded-2xl shadow-sm mb-4 group focus:ring-4 focus:ring-brand-100 focus:outline-none"
        >
        ...
        <button
          ...
          className="w-full text-slate-500 hover:text-slate-800 transition-colors font-semibold py-3 text-[15px] flex items-center justify-center gap-2 group hover:bg-slate-50 rounded-2xl"
        >
          Continue as Guest
