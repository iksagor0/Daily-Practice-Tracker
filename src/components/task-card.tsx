...
export const TaskCard: React.FC<ITaskCardProps> = ({
  ...
  if (isDone) {
    return (
      <div
        className="bg-slate-50 border border-slate-200 shadow-sm rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center gap-4 opacity-80 hover:opacity-100 transition-opacity group relative animate-slide-up opacity-0 fill-mode-forwards"
      ...
      >
        ...
        <div className="flex-1 min-w-0 w-full">
          ...
          <p className="text-slate-400 text-sm leading-relaxed truncate">{task.desc}</p>
        </div>
